...
function setup() {
  mycanvas = createCanvas(640,640,WEBGL);
  mycanvas.parent("sketch");
  ...
  pgraphics= createGraphics(mycanvas.width, mycanvas.height)
...
function draw() {
  ...
  minaPixel(2, posP4.x, posP4.y, 10, 10, 40, random(2,4))
  xP4 = posP4.x
  yP4 = posP4.y

  let posP3 = rWalk(xP3, yP3, 10)
  myPixel_Perlin(5,posP3.x, posP3.y, random(20,25), 20);
  myPixel_02(5, posP3.x, posP3.y, 20, 20,90, 2);
  // console.log( posP3)
  xP3 = posP3.x
  yP3 = posP3.y
  ...
  let posP2 = pWalk(xoffP2, yoffP2)
  myPixel_Perlin(5, posP2.x, posP2.y, 20, 20);
  xoffP2 += 0.001;
  yoffP2 += 0.001;


  let posP1 = rWalk(xP1, yP1, 30 / 2)
  myPixel_01(10, posP1.x, posP1.y, 30, 30, 40, random(2,4));
  xP1 = posP1.x
  yP1 = posP1.y
